...
/**
 * Novacash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZnovaSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setznovaseed(const UniValue& params, bool fHelp);
extern UniValue getznovaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznova(const UniValue& params, bool fHelp);
extern UniValue dznovastate(const UniValue& params, bool fHelp);
