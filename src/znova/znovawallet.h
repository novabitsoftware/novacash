...
#ifndef Novacash_ZNOVAWALLET_H
#define Novacash_ZNOVAWALLET_H
...
public:
    CzNOVAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNOVA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNOVA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
