...
#ifndef Novacash_ZNOVATRACKER_H
#define Novacash_ZNOVATRACKER_H
...
public:
    CzNOVATracker(std::string strWalletFile);
    ~CzNOVATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNOVAWallet* zNOVAWallet = NULL);
