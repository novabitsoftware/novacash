...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NOVA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNovacashAmount"))
        SoftSetArg("-anonymizenovacashamount", settings.value("nAnonymizeNovacashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in novacash.cpp during shotdown to also remove the window positions
