...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Novacash Core"),
     ...
     * override -datadir in the novacash.conf file in the default data directory
     * (to be consistent with novacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
