                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Novacash Core") + " - ";
#ifdef ENABLE_WALLET
...
//    labelAutoMintIcon = new QPushButton(); // GAM 23-Dec-2019: Novacash does not support Automint!
//    labelAutoMintIcon->setObjectName("labelAutoMintIcon"); // GAM 23-Dec-2019: Novacash does not support Automint!
//    labelAutoMintIcon->setFlat(true); // Make the button look like a label, but clickable // GAM 23-Dec-2019: Novacash does not support Automint!
//    labelAutoMintIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0);}"); // GAM 23-Dec-2019: Novacash does not support Automint!
//    labelAutoMintIcon->setMaximumSize(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE); // GAM 23-Dec-2019: Novacash does not support Automint!
    ...
    if (enableWallet) {
        ...
        frameBlocksLayout->addStretch();
//        frameBlocksLayout->addWidget(labelAutoMintIcon); // GAM 23-Dec-2019: Novacash does not support Automint!
    }
#endif // ENABLE_WALLET
...
//    connect(labelAutoMintIcon, SIGNAL(clicked()), this, SLOT(optionsClicked())); // GAM 23-Dec-2019: Novacash does not support Automint!
...
//    QTimer* timerAutoMintIcon = new QTimer(labelAutoMintIcon); // GAM 23-Dec-2019: Novacash does not support Automint!
//    connect(timerAutoMintIcon, SIGNAL(timeout()), this, SLOT(setAutoMintStatus())); // GAM 23-Dec-2019: Novacash does not support Automint!
//    timerAutoMintIcon->start(10000); // GAM 23-Dec-2019: Novacash does not support Automint!
//    setAutoMintStatus(); // GAM 23-Dec-2019: Novacash does not support Automint!
}
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Novacash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and novacash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNOVA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Novacash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Novacash Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Novacash"));
    ...
    signMessageAction = new QAction(QIcon(":/icons/inkpot"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your Novacash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/check"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Novacash addresses"));
    ...
    multiSendAction = new QAction(QIcon(":/icons/percent"), tr("&MultiSend"), this);
    multiSendAction->setToolTip(tr("MultiSend Settings"));
    multiSendAction->setCheckable(true);

    openInfoAction = new QAction(QIcon(":/icons/about"), tr("&Information"), this);
    openInfoAction->setStatusTip(tr("Show diagnostic information"));
    openRPCConsoleAction = new QAction(QIcon(":/icons/console"), tr("&Debug console"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging console"));
    openNetworkAction = new QAction(QIcon(":/icons/radar"), tr("&Network Monitor"), this);
    ...
    openConfEditorAction = new QAction(QIcon(":/icons/document_gear"), tr("Open Wallet &Configuration File"), this);
    openConfEditorAction->setStatusTip(tr("Open configuration file"));
    openMNConfEditorAction = new QAction(QIcon(":/icons/document_gear"), tr("Open &Masternode Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open Masternode configuration file"));
    showBackupsAction = new QAction(QIcon(":/icons/data_copy"), tr("Show Automatic &Backups"), this);
    ...
    multisigCreateAction = new QAction(QIcon(":/icons/gearwheel"), tr("&Multisignature creation..."), this);
    multisigCreateAction->setStatusTip(tr("Create a new multisignature address and add it to this wallet"));
    multisigSpendAction = new QAction(QIcon(":/icons/checkbook"), tr("&Multisignature spending..."), this);
    multisigSpendAction->setStatusTip(tr("Spend from a multisignature address"));
    multisigSignAction = new QAction(QIcon(":/icons/inkpot"), tr("&Multisignature signing..."), this);
    multisigSignAction->setStatusTip(tr("Sign with a multisignature address"));

    openAction = new QAction(QIcon(":/icons/handoffer"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a Novacash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Novacash Core help message to get a list with possible Novacash command-line options"));
...
//        toolbar->addAction(privacyAction); // GAM 20-Dec-2019 Novacash does not support minting!
...
//        toolbar->addAction(governanceAction); // GAM 20-Dec-2019 Novacash does not support minting!
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Novacash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Novacash network", "", count));
}
...
{
    QString strTitle = tr("Novacash Core"); // default title
...
{
/* // GAM 23-Dec-2019: Novacash does not support Automint!
    if (walletFrame) {
        if (fEnableZeromint) {
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::UnlockedForAnonymizationOnly:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setIcon(QIcon(":/icons/lock_open").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
//        labelEncryptionIcon->setToolTip(tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b> for anonymization and staking only")); // GAM 06-Jan-2020 Novacash does not support Minting
