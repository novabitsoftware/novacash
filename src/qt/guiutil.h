...
/** Utility functions used by the Novacash Qt UI.
 */
namespace GUIUtil
{
...
// Render Novacash addresses in monospace font
...
// Parse "novacash:" URI into recipient object, return true on successful parsing
