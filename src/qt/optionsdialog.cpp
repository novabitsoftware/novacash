...
/* Window elements init */
    ...
    if (!enableWallet) {
        ...
        ui->verticalZnovaOptionsWidget->hide();
        ui->verticalZnovaDisplayWidget->hide();
    }

    /* Display elements init */
    ui->checkBoxZeromintEnable->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
    ui->checkBoxZeromintAddresses->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
    ui->percentage_label->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
    ui->zeromintPercentage->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
    ui->labelPreferredDenom->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
    ui->preferredDenom->hide(); // GAM 23-Dec-2019: Novacash does not support Automint
