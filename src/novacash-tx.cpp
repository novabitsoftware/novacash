...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Novacash Core novacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  novacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded novacash transaction") + "\n" +
                               "  novacash-tx [options] -create [commands]   " + _("Create hex-encoded novacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded novacash transaction
