...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the NOVA and zNOVA money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 15548, 25548));
...
//    strUsage += HelpMessageOpt("-znovastake=<n>", strprintf(_("Enable or disable staking functionality for zNOVA inputs (0-1, default: %u)"), 1)); // GAM 23-Dec-2019: Novacash does not support Zerocoin!
    ...
    strUsage += HelpMessageOpt("-masternodeaddr=<n>", strprintf(_("Set external address:port to get to this masternode (example: %s)"), "128.127.106.235:15548"));
...
//    strUsage += HelpMessageOpt("-reindexzerocoin=<n>", strprintf(_("Delete all zerocoin spends and mints that have been recorded to the blockchain database and reindex them (0-1, default: %u)"), 0)); // GAM 23-Dec-2019: Novacash does not support Zerocoin
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 15547, 25547));
