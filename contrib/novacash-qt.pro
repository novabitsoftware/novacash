...
RESOURCES += src/qt/novacash.qrc src/qt/novacash_locale.qrc

TRANSLATIONS += src/qt/locale/novacash_bg.ts \
                src/qt/locale/novacash_de.ts \
                src/qt/locale/novacash_en.ts \
                src/qt/locale/novacash_es.ts \
                src/qt/locale/novacash_fi.ts \
                src/qt/locale/novacash_fr.ts \
                src/qt/locale/novacash_it.ts \
                src/qt/locale/novacash_ja.ts \
                src/qt/locale/novacash_pl.ts \
                src/qt/locale/novacash_pt.ts \
                src/qt/locale/novacash_ru.ts \
                src/qt/locale/novacash_sk.ts \
                src/qt/locale/novacash_sv.ts \
                src/qt/locale/novacash_vi.ts \
                src/qt/locale/novacash_zh_CN.ts \
                src/qt/locale/novacash_zh_TW.ts
