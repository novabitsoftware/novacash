Contributing to Novacash Core
============================

The Novacash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/novacash-project/novacash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Novacash Core project, and is not to be
confused with overall Novacash Network Protocol consensus changes.

Whether a pull request is merged into Novacash Core rests with the project merge
...
Patches that change Novacash consensus rules are considerably more involved than
...
Where a patchset proposes to change the Novacash consensus, it must have been
...
The project leader is the release manager for each Novacash Core release.
