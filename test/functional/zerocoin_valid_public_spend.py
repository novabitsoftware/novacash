...
from fake_stake.base_test import Novacash_FakeStakeTest

class zNOVAValidCoinSpendTest(Novacash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNOVAs..." % DENOM_TO_USE)
